...
urlpatterns = [
    ...
    path('blog-details/<str:sluge_str>/', views.blog_details, name="blog_details"),
    ...
    path('doctor/', authentication_view.doctor, name="doctor"),
    path('patient/', authentication_view.patient, name="patient"),
    path('logout/', authentication_view.logout_user, name="logout"),
    path('tinymce/', include('tinymce.urls')),#HTMLFIELD
